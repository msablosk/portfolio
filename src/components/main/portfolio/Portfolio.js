  ...
  render() {
    return (
      <section className="Portfolio">
        <ul>
          <li>
            <a href="https://pages.mitchellsablosky.com/paper/">
          ...
          <li>
            <a href="https://pages.mitchellsablosky.com/notey/">
          ...
          <li>
            <a href="https://pages.mitchellsablosky.com/one-pager/">
          ...
          <li>
            <a href="https://pages.mitchellsablosky.com/Der, Die, Das/">
          ...
          <li>
            <a href="https://pages.mitchellsablosky.com/weather/">
